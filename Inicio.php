...
include_once 'modelo/LoginModels.php';
$log = new Login();
...
<!--     Custom Fonts-->
    ...
    <link href="css/InicioIconoscss.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a><?php echo $log->Mostrar_dato(3,$id_usu) ?> </a>
                    </li>
                    <li class="page-scroll">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <span class="name">ORDEN DE COMPRAS COORPORATIVAS</span>
                        <hr class="star-light">
                        <span class="skills">Conmiciv - Esmeralda - Corimayo</span>
                    </div>
                </div>
            </div>
        </div>
	...
	<section class="cuadros" id="menuprincipal">
            <center><h2>MENU PRINCIPAL</h2></center>
                    <article>
                            ...
                            <figure>
                                <a href="vistas/oc.php" >		
                                <img src="img/inicio/iconoc.jpg" alt="Radios"></a>
                            </figure>
                    </article>
                    <article >
                             <h3>Manto de datos</h3>
                            <figure>
                                <a href="vistas/Menu_Mantenimiento.php" >		
                                    <img src="img//inicio/iconmanto.png" alt="Radios"></a>
                            </figure>
                    </article>
                    <article>
                        <h3>Reportes</h3>
                            <figure>
                                <a href="vistas/Ordenesdecompras/Ocview.php" >	
    ...
    <footer class="text-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        <h3>Ubicacion</h3>
                        <p>Ca. Machu Picchu Mz L lt 9</p>
                    </div>
                    <div class="footer-col col-md-4">
                        <h3>Mineria,Tecnologia y Desarrollo</h3>
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright derechos reservados de autor &copy; Aplicacion Ordenes de Compras Coorporativas 2016
                    </div><br>
                    <div class="col-lg-12">
                        by Marcos Chacaliaza Altamirano
                    </div>
                </div>
            </div>
        </div>
