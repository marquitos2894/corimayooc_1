...
<!--            <div class="container">
    ...
    <body id="page-top" class="index" > 
        ...
        <form name="FrmBuscar" action="" method="post">
            ...
            <h1 align="center"><a class="fancybox fancybox.iframe; btn btn-warning" href='InsEquiposV.php'>Nuevo Equipo</a></h1>  
            <h1 align="center">Mantenimiento de Equipos</h1>
            <input type="search" name="buscar" autocompleye="off" placeholder="BUSCA EQUIPOS" id="busquedaEquipos" value="" class="form-control" />
