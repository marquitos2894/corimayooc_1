...
<!--            <div class="container">
    ...
    <body id="page-top" class="index" > 
        ...
        <form name="FrmBuscar" action="" method="post">
            ...
            <h1 align="center"><a class="fancybox fancybox.iframe; btn btn-warning" href='InsEmpresaV.php'>Nuevo Empresa</a></h1>  
            <h1 align="center">Mantenimiento de Mis Empresa</h1>
            <input type="search" name="buscar" autocompleye="off" placeholder="INGRESE UN DATO" id="busquedaEmpresa" value="" class="form-control" />
